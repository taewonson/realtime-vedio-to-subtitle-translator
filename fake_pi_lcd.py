"""PC에서 라즈베리파이 LCD 동작을 독립적으로 테스트하는 PySide6 화면입니다."""
...
class SubtitleLcdWindow(QMainWindow):
    def __init__(self) -> None:
        super().__init__()
        self.setWindowTitle("Subtitle LCD (Fake Raspberry Pi) - PySide6")
...
def main() -> int:
    ...
    app.setApplicationName("Subtitle LCD Fake")
